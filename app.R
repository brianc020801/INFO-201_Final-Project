...
ui <- shinyUI(navbarPage(
  ...
  theme = "styles.css",
  setBackgroundImage(
    src = "https://getwallpapers.com/wallpaper/full/7/4/b/1159328-white-background-wallpaper-iphone-1080x1920-xiaomi.jpg"
  ),
  tabPanel(
    "Introduction",
    ...
    p(
      ...
      such as recommend age, rating, IMDB rating, Rotten Tomatoes rating, the difference between the two ratings, and the year released.", align = "center"
    ),
    p("The three interactives for this project are,
      ...
      With the last one being a comparison between the language the movie was in and its IMDb rating.", align = "center"),
    p("The Age vs Rating interactive allows users to select two age ratings from the list provided and then can see and compare the average IMDb rating from a movie with that rating.
      ...
      The final interactive of Language vs Rating allows users to type in a language and see in a scatterplot a comparison of IMDb and Rotten Tomatoes ratings of the movies in that language.", align = "center"),
    p("Finally the project attempts to look into and analyze comparisons between different features of a movie and what ratings it achieved.
      ...
      Finally, the last interactive looks to see if a movie language affects its rating in both IMDb and Rotten Tomatoes.", align = "center"),
    tags$style(
      "p {color: #404040 !important;
          font-family: Rockwell !important;
          font-size: 20px !important;}",
      ".navbar {background-color: #00A8E1 !important;}",
      "body {background-color: #fdfcfc !important; }",
      ".navbar-default .navbar-brand {color: white !important;}",
      ".navbar-default .navbar-tabs {color: white !important;}"
    )
  ),
  tabPanel(
    "Interactives",
    tabsetPanel(
      tabPanel(
        ...
        br(),
        p("Let's compare a movie age recommendation and the rating that movie received on IMDb", align = "center"),
        sidebarLayout(
          sidebarPanel(
            selectInput(
              "age",
      ...
      tabPanel(
        "Year vs Rating",
        h1("Year vs Rating", align = "center"),
        tags$img(
      ...
      tabPanel("Language vs Rating",
               h1("Language vs Rating", align = "center"),
               tags$img(
